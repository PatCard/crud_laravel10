...
class TaskController extends Controller
{
    ...
    public function index(): View
    {
        //
        //$tasks = Task::all();
        //$tasks = Task::latest()->get(); //Luego de cambiar a Paginator
        $tasks = Task::latest()->paginate(3); //# numero de elementos a mostrar
     ...
     */
    public function destroy(Task $task): RedirectResponse //Declaracion de tipo
    {
        //dd($task);
        $task->delete();
